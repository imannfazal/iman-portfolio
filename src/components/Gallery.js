    ...
    return (
        <div>
            ...
            <div class="inline-flex mt-[50px] text-[#5f5f5f] text-[20px]">
                ...
                <a href='/Fortune-Rush' class='ml-24 lift cursor-pointer'><Image role='Website Design and Development' text='Fortune Rush' src={Rush} /></a>
                <a href='/prediction' class='ml-24 lift cursor-pointer'><Image role='Website Design' text='Prediction Beta' src={pred} /></a>
