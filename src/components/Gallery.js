...
import fridge from '../assets/fridgesense/screen-1.jpg'

const Gallery = () => {
    return (
        <div>
            <div class="grid grid-cols-3 md:gap-9 gap-3 mt-[20px] text-[#5f5f5f] text-[20px]">
                <a href='/iman-portfolio/#/fridge-sense' class='lift cursor-pointer'><Image role='Website Design & Development' text='Fridge Sense' src={fridge} /></a>
