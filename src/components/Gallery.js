    ...
    return (
        <div>
            ...
            <div class="inline-flex mt-[50px] text-[#5f5f5f] text-[20px]">
                <img class='h-[300px] w-[390px] lift cursor-pointer rounded-[5px]' alt='work' src={Rush} />
                <img class='h-[300px] w-[390px] lift cursor-pointer ml-24 rounded-[5px]' width='100%' alt='work' src={bank} />
